...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox.setGeometry(QtCore.QRect(200, 55, 161, 26))
        self.comboBox.setObjectName("comboBox")
        self.leNumTourn = QtWidgets.QLineEdit(self.centralwidget)
        self.leNumTourn.setGeometry(QtCore.QRect(240, 91, 81, 24))
        self.leNumTourn.setObjectName("leNumTourn")
        self.lbNumTourn = QtWidgets.QLabel(self.centralwidget)
        self.lbNumTourn.setGeometry(QtCore.QRect(220, 95, 21, 16))
        self.lbNumTourn.setObjectName("lbNumTourn")
        self.cbEnableNumTourn = QtWidgets.QCheckBox(self.centralwidget)
        self.cbEnableNumTourn.setGeometry(QtCore.QRect(340, 190, 20, 20))
        self.cbEnableNumTourn.setObjectName("cbEnableNumTourn")
        self.lbEnableNumTourn = QtWidgets.QLabel(self.centralwidget)
        self.lbEnableNumTourn.setGeometry(QtCore.QRect(365, 183, 120, 31))
        self.lbEnableNumTourn.setObjectName("lbEnableNumTourn")
        ...
        self.lbSkip.setGeometry(QtCore.QRect(70, 183, 200, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cbEnableNumTourn.setText(_translate("MainWindow", ""))
        self.lbEnableNumTourn.setText(_translate("MainWindow", "Enable ownership"))
        ...
        self.lbNumTourn.setText(_translate("MainWindow", "№"))
